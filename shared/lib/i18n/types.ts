...
export interface Translations {
  ...
  dailyActivities: {
    ...
    missingActivitiesCount: string
    // Activity expectations
    mealsExpected: string
    napsExpected: string
    bathroomExpected: string
    moodsExpected: string
    // Bulk registration modal
    bulkRegistration: string
    bulkRegistrationDesc: string
    selectChildren: string
    selectAll: string
    deselectAll: string
    activityType: string
    ...
    diaperType: string
    energy: string
    registerActivities: string
    childrenSelected: string
    // Daily report modal
    dailyReport: string
    dailyReportFor: string
