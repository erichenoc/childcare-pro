      ...
      {isOpen && (
        <>
          ...
          {isMobile ? (
            ...
            >
              ...
              >
                ...
                <div className="px-6 py-4 border-b border-[var(--glass-border)]">
                  <h3 className="text-lg font-semibold text-white">Seleccionar Modelo</h3>
            ...
            /* Desktop: Popover */
            <div className="absolute top-full mt-2 left-0 w-[320px] glass-strong rounded-xl overflow-hidden z-50 shadow-2xl animate-fade-in">
