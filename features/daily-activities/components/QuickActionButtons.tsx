...
import { MEAL_TYPE_LABELS, AMOUNT_EATEN_LABELS, MOOD_LABELS, MOOD_EMOJIS } from '@/shared/types/daily-activities'
...
export function QuickActionButtons({ childId, childName, onSuccess }: QuickActionButtonsProps) {
  ...
  const [activeAction, setActiveAction] = useState<'meal' | 'nap' | 'diaper' | 'mood' | null>(null)
