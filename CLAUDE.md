...
|--------|--------|-------------|
| Autenticacion | Completado | Supabase Auth con email/password + Google OAuth |
| Familias | Completado | CRUD completo de familias |
| Ninos | Completado | CRUD completo con perfiles detallados |
| Staff | Completado | Gestion de personal |
| Salones | Completado | Gestion de classrooms |
...
**Archivos clave:**
- `features/billing/services/stripe.service.ts` - Servicio cliente
- `app/api/stripe/checkout/route.ts` - Crear sesiones de checkout
- `app/api/stripe/webhook/route.ts` - Procesar webhooks de pago
...
**ChildCare Pro** es una plataforma SaaS multi-tenant para la gestión integral de guarderías y centros de cuidado infantil.

**Características principales:**
- Gestión de niños, familias y personal
- Control de asistencia con modo kiosco
- Seguimiento de ratios DCF de Florida en tiempo real
- Facturación automatizada con Stripe
- Portal de padres con reportes diarios
- Comunicación staff-padres (mensajes, fotos, notificaciones)
- Reportes de cumplimiento DCF
- Sistema de internacionalización (Español/Inglés)

**Diseño:** Sistema Liquid Glass (Apple iOS 26 style)
**Target Market:** Guarderías en Florida, USA
